...
import static uz.online.teacher.constants.swaggerdoc.SubjectTypeDoc.*;
...
public class SubjectTypeController {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            schema = @Schema(implementation = ResponseDto.class, subTypes = SubjectTypeDto.class))
            ),
            @ApiResponse(
                    responseCode = "400",
    ...
    @GetMapping("{id}")
    public ResponseEntity<ResponseDto<SubjectTypeDto>> getOne(@PathVariable Integer id) {
    ...
    @GetMapping("all")
    public ResponseEntity<ResponseDto<List<SubjectTypeDto>>> getAll() {
    ...
    @GetMapping("list")
    public ResponseEntity<ResponseDto<Page<SubjectTypeDto>>> getList(@RequestParam Integer page, @RequestParam Integer size) {
        return ResponseEntity.ok(service.getList(page, size));
    }
    @Operation(
            description = "Update new SubjectType",
    ...
    @PostMapping
    public ResponseEntity<ResponseDto<SubjectTypeDto>> create(@RequestBody @Valid SubjectTypeForm form) throws ParseException {
    ...
    @PutMapping("{id}")
    public ResponseEntity<ResponseDto<SubjectTypeDto>> update(@PathVariable Integer id, @RequestBody @Valid SubjectTypeForm form) throws ParseException {
