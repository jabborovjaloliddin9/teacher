...
import static uz.online.teacher.constants.swaggerdoc.SchoolYearDoc.*;
...
public class SchoolYearController {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            schema = @Schema(implementation = ResponseDto.class, subTypes = SchoolYearDto.class))
            ),
            @ApiResponse(
                    responseCode = "400",
    ...
    @GetMapping("{id}")
    public ResponseEntity<ResponseDto<SchoolYearDto>> getOne(@PathVariable Integer id) {
    ...
    @GetMapping("all")
    public ResponseEntity<ResponseDto<List<SchoolYearDto>>> getAll() {
    ...
    @GetMapping("list")
    public ResponseEntity<ResponseDto<Page<SchoolYearDto>>> getList(@RequestParam Integer page, @RequestParam Integer size) {
        return ResponseEntity.ok(service.getList(page, size));
    }
    @Operation(
            description = "Update new SchoolYear",
    ...
    @PostMapping
    public ResponseEntity<ResponseDto<SchoolYearDto>> create(@RequestBody @Valid SchoolYearForm form) throws ParseException {
    ...
    @PutMapping("{id}")
    public ResponseEntity<ResponseDto<SchoolYearDto>> update(@PathVariable Integer id, @RequestBody @Valid SchoolYearForm form) throws ParseException {
