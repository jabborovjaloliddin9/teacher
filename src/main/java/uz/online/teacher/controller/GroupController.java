...
import static uz.online.teacher.constants.swaggerdoc.GroupDoc.*;
...
public class GroupController {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            schema = @Schema(implementation = ResponseDto.class, subTypes = GroupDto.class))
            ),
            @ApiResponse(
                    responseCode = "400",
    ...
    @GetMapping("{id}")
    public ResponseEntity<ResponseDto<GroupDto>> getOne(@PathVariable Integer id) {
    ...
    @GetMapping("list")
    public ResponseEntity<ResponseDto<Page<GroupDto>>> getList(@RequestParam Integer page, @RequestParam Integer size) {
        return ResponseEntity.ok(service.getList(page, size));
    }
    @Operation(
            description = "Update new Group",
    ...
    @PostMapping
    public ResponseEntity<ResponseDto<GroupDto>> create(@RequestBody @Valid GroupForm form) throws ParseException {
    ...
    @PutMapping("{id}")
    public ResponseEntity<ResponseDto<GroupDto>> update(@PathVariable Integer id, @RequestBody @Valid GroupForm form) throws ParseException {
